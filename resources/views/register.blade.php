<x-layouts>
    ...
    <main class="flex-1 mt-15 ">
        <div class="items-center flex  pt-5 lg:space-x-8 mx-auto px-6 md:px-10 lg:max-w-6xl">
            <img class="hidden  w-1/2 lg:flex" src="{{ asset('assets/undraw_welcoming_xvuq.svg') }}" alt="">
            <div class="w-full lg:w-1/2 ">
                <h1 class="text-2xl font-bold">Register</h1>
                <form action="/register" method="POST">
                    @csrf
                    <div class="mt-4 ">
                        <label class="block mb-2 text-sm text-gray-600" for="">Name</label>
                        <input
                    ...
                    <div class="mt-4">
                        <label class="block mb-2 text-sm text-gray-600" for="">Confirm Password</label>
                        <input
                            class="w-full px-4 py-2 text-gray-700 bg-white border border-gray-300 rounded-lg focus:border-purple-500 focus:outline-none"
                    ...
                    <div class="mt-8">
                        <button type="submit"
                            class=" px-4 py-2 rounded-md text-sm w-full font-medium border-0 focus:outline-none focus:ring transition-colors text-white bg-purple-500 hover:bg-purple-600 active:bg-purple-700 focus:ring-purple-300">Register</button>
                    </div>
                    <div class="mt-4 flex align-middle justify-center">
                        <hr class="w-1/3 border-gray-800 mt-3">
                        <div class="text-gray-600 mx-2">Or Register with</div>
                        <hr class="w-1/3 border-gray-800 mt-3">
                    </div>
                ...
                <div class="mt-5">
                    <p class="text-gray-600">Already have account? <a href="/login" class="text-purple-500">Login
                            here</a></p>
                </div>
            </div>
        </div>
